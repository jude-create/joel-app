...
function WhatsappSocial() {
  return (
    <div className='text-center font-unigeo space-y-8 md:space-y-14 flex flex-col justify-center items-center '>
        ...
        <p className='text-base w-80  leading-9 md:w-[700px] xl:w-[900px]  md:font-light text-center md:leading-[50px]'>If you need a product designer who speaks and understands both human and business, crafting solutions that delight users and drive results,
